 ...
 */
public class EventArchiveIndexQueueDaoImpl implements EventIndexQueueDao, ApplicationEventPublisherAware {
    ...
    public EventArchiveIndexQueueDaoImpl(DataSource ds, boolean isArchive, EventDaoHelper daoHelper,
